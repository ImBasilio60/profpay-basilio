...
<html lang="fr">
  ...
  <body class="bg-gray-100 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
      ...
      <main
        class="flex-1 p-8 ml-16 pb-0 transition-all duration-300 rounded-l-2xl overflow-auto"
        id="mainContent"
      >
        <div id="notification" class="flex justify-between items-center mb-4">
          <div class="flex items-center gap-6">
            ...
            <h2 class="text-2xl font-bold">Professeurs infos</h2>
          </div>
                  ...
                  >
                   <div>
                    ...
                    <div class="form-row">
                      ...
                      <div>
                        <select
                          class="w-full p-2 h-8 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 small-txt"
                          id="categorie"
                        >
                      ...
                      <div class="mt-5">
                        <button
                          type="button"
                          class="w-64 flex items-center justify-center gap-2 p-3 mb-4 text-white font-medium rounded-lg shadow-md focus:outline-none h-9 transition duration-200 text-white bg-indigo-500"
                          id="addBtn"
                          data-state="ajout"
                        >
              ...
              <div id="profile" class="hidden tab-content w-full h-1/2">
                <div class="bg-white p-6 pt-2 pb-3 rounded-lg shadow-md w-full">
                  ...
                  <div class="flex gap-4 mb-">
                    ...
                    />
                    <select
                      class="w-64 p-2 h-8 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 small-txt"
                      id="prof-filter"
                    >
                  ...
                  <table class="min-w-full table-auto bg-white shadow-xs text-sm">
                    <thead class="bg-gray-100">
                      <tr>
                        <th class="px-4 py-2 text-left font-medium">Matricule</th>
                        <th class="px-4 py-2 text-left font-medium">Nom</th>
                        <th class="px-4 py-2 text-left font-medium">Catégorie</th>
                        <th class="px-4 py-2 text-left font-medium">Téléphone</th>
                        <th class="px-4 py-2 text-left font-medium">Actions</th>
                      </tr>
                    </thead>
                    <tbody id="professeur-table">
                      <tr class="border-b border-gray-200">
                        <td class="px-4 py-2">298C1</td>
                        <td class="px-4 py-2">John Doe</td>
                        <td class="px-4 py-2">2500</td>
                        <td class="px-4 py-2">15 Mars 2025</td>
                  ...
                  <div class="flex justify-end mt-4">
                    <nav class="flex space-x-2 pagination small-txt" id="prof-pagination"></nav>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="../public/modules/professeurs/navTabs.js"></script>
    <script type="module" src="../public/modules/crudProf.js"></script>
